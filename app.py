...
def predict1():
    ...
    return render_template('index.html', prediction_text1 = 'EC and pH with Random Forest Model should be {}'.format(prediction1))
...
def predict2():
    ...
    return render_template('index.html', prediction_text2 = 'EC and pH with Gradient Boosting Model should be {}'.format(prediction2))
